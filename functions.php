...
if ( ! function_exists( 'fertilegroundscafe_setup' ) ) :
	 ...
	 */
	function fertilegroundscafe_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Fertile Grounds Cafe, use a find and replace
...
add_action( 'after_setup_theme', 'fertilegroundscafe_setup' );
 ...
 */
function fertilegroundscafe_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'fertilegroundscafe' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'fertilegroundscafe' ),
...
function fertilegroundscafe_scripts() {
	...
	wp_enqueue_script( 'fertilegroundscafe-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'fertilegroundscafe-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
